...
SECRET_KEY = 'django-insecure-)ra^*=1#!=t^lt)a4-k@gy9vwtp(8i7ld=k&vf+d-+-lqv0pzx'
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static')]  # Look for static files in a 'static' folder inside your app
